...
test('Union boolean operation', (t) => {
  ...
  t.is(pathOne.op(pathTwo, PathOp.Union).toSVGString(), 'M142 0L58 0C53.5817 0 50 3.58172 50 8L50 50L8 50C3.58172 50 0 53.5817 0 58L0 142C0 146.418 3.58172 150 8 150L92 150C96.4183 150 100 146.418 100 142L100 100L142 100C146.418 100 150 96.4183 150 92L150 8C150 3.58172 146.418 0 142 0Z')
})
...
test('Difference boolean operation', (t) => {
  ...
  t.is(pathOne.op(pathTwo, PathOp.Difference).toSVGString(), 'M50 50L8 50C3.58172 50 0 53.5817 0 58L0 142C0 146.418 3.58172 150 8 150L92 150C96.4183 150 100 146.418 100 142L100 100L58 100C53.5817 100 50 96.4183 50 92L50 50Z')
})
...
test('ReverseDifference boolean operation', (t) => {
  ...
  t.is(pathOne.op(pathTwo, PathOp.ReverseDifference).toSVGString(), 'M142 0L58 0C53.5817 0 50 3.58172 50 8L50 50L92 50C96.4183 50 100 53.5817 100 58L100 100L142 100C146.418 100 150 96.4183 150 92L150 8C150 3.58172 146.418 0 142 0Z')
})
...
test('Intersect boolean operation', (t) => {
  ...
  t.is(pathOne.op(pathTwo, PathOp.Intersect).toSVGString(), 'M100 100L58 100C53.5817 100 50 96.4183 50 92L50 50L92 50C96.4183 50 100 53.5817 100 58L100 100Z')
})
